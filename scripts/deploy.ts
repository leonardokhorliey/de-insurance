...
// Contract
  ...
  const verifier = await Verifier.deploy("0x5F92394708b560383B19a69bC7dC75549EC15B41");
  ...
  const pool = await Pool.deploy("0x5F92394708b560383B19a69bC7dC75549EC15B41", verifier.address, "0xAE657Be47195f0a2AC3b13c3fd1BA30A3C6234Bd");
